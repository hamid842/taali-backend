...
//        }
    ...
    fun getPermissionsForRole(role: UserRole): List<String> = when (role) {
        ...
        UserRole.STUDENT -> listOf(
            "profile:read", "grades:read", "attendance:read", "assignments:read", "classes:read", "schedule:view"
        )
    ...
    fun getAllMenuItems(): List<MenuItemDto> = buildMenuTree(menuItemRepository.listAll(), "en")
    ...
    fun getMenuHierarchy(): List<MenuItemDto> = buildMenuTree(menuItemRepository.findByParentIsNull(), "en")
    ...
    fun getAccessibleRoutes(userRole: UserRole): List<String> =
        menuItemRepository.findByRole(userRole.name).mapNotNull { it.route }
    ...
    private fun mapToDto(menuItem: MenuItem, allItems: List<MenuItem>, locale: String): MenuItemDto {
        val children = allItems.filter { it.parent?.id == menuItem.id }.sortedBy { it.orderIndex }
    ...
    fun createDefaultMenu() {
        ...
        // ==================== OWNER MENU ====================
        val ownerDashboard = createMenuItem(
            "menu_dashboard", "layout-dashboard", "/owner/dashboard", "/owner/dashboard", 0, setOf(UserRole.OWNER)
        )

        val ownerSchoolManagement =
            createMenuItem("menu_school_management", "school", null, null, 1, setOf(UserRole.OWNER))
        createMenuItem(
            "menu_create_school",
            "plus",
            "/owner/schools/create",
            "/owner/schools/create",
            0,
            setOf(UserRole.OWNER),
            ownerSchoolManagement,
            "school:create"
        )
        createMenuItem(
            "menu_list_schools",
        ...
        val ownerUserManagement = createMenuItem(
            "menu_user_management", "users-round", null, null, 2, setOf(UserRole.OWNER)
        )
        createMenuItem(
            "menu_create_user",
            "user-plus",
        ...
        // ==================== SCHOOL MANAGER MENU ====================
        val adminDashboard = createMenuItem(
            "menu_dashboard",
            "layout-dashboard",
            "/manager/dashboard",
            "/manager/dashboard",
            0,
            setOf(UserRole.SCHOOL_MANAGER)
        )

        val adminUserManagement =
            createMenuItem("menu_user_management", "users-round", null, null, 1, setOf(UserRole.SCHOOL_MANAGER))
        createMenuItem(
            "menu_create_user",
            "user-plus",
        ...
        val adminClassManagement =
            createMenuItem("menu_class_management", "grid-2x2", null, null, 2, setOf(UserRole.SCHOOL_MANAGER))
        createMenuItem(
            "menu_list_classes",
            "list",
            "/manager/classes",
        ...
        val adminTeacherManagement =
            createMenuItem("menu_teacher_management", "contact", null, null, 3, setOf(UserRole.SCHOOL_MANAGER))
        createMenuItem(
            "menu_list_teachers",
            "list",
            "/manager/teachers",
        ...
        val adminStudentManagement =
            createMenuItem("menu_student_management", "graduation-cap", null, null, 4, setOf(UserRole.SCHOOL_MANAGER))
        createMenuItem(
            "menu_list_students",
            "list",
            "/manager/students",
        ...
        val adminParentManagement =
            createMenuItem("menu_parent_management", "file-user", null, null, 5, setOf(UserRole.SCHOOL_MANAGER))
        createMenuItem(
            "menu_list_parents",
            "list",
            "/manager/parents",
        ...
        val adminLessonsManagement =
            createMenuItem(
                "menu_lessons_management",
                "book-open",
                null,
                null,
                6,
        ...
        // School Settings
        val adminSchoolSettings = createMenuItem(
            "menu_school_settings",
            "settings",
            null,
            null,
            7,
        ...
        createMenuItem(
            "menu_timestamp",
            "alarm-clock",
            "/manager/school-settings/timestamp",
            "/manager/school-settings/timestamp",
            0,
            setOf(UserRole.SCHOOL_MANAGER),
            adminSchoolSettings,
        ...
        createMenuItem(
            "menu_school_profile",
            "school",
            "/manager/school-settings/profile",
            "/manager/school-settings/profile",
            1,
            setOf(UserRole.SCHOOL_MANAGER),
            adminSchoolSettings,
        ...
        val adminFinance = createMenuItem("menu_finance", "dollar-sign", null, null, 8, setOf(UserRole.SCHOOL_MANAGER))
        createMenuItem(
            "menu_finance_tuition",
            "credit-card",
            "/manager/finance/tuition",
            "/manager/finance/tuition",
            0,
            setOf(UserRole.SCHOOL_MANAGER),
            adminFinance,
        ...
        createMenuItem(
            "menu_finance_invoice",
            "file-text",
            "/manager/finance/invoice",
            "/manager/finance/invoice",
            1,
            setOf(UserRole.SCHOOL_MANAGER),
            adminFinance,
        ...
        val supervisorDashboard = createMenuItem(
            "menu_dashboard",
            "layout-dashboard",
            "/admin/dashboard",
            "/admin/dashboard",
            0,
            setOf(UserRole.SCHOOL_ADMIN)
        )

        // Teacher Management with children (same as ADMIN)
        val supervisorTeacherManagement =
            createMenuItem("menu_teacher_management", "contact", null, null, 1, setOf(UserRole.SCHOOL_ADMIN))
        createMenuItem(
            "menu_list_teachers",
            "list",
            "/admin/teachers",
        ...
        val supervisorClassManagement =
            createMenuItem("menu_class_management", "grid-2x2", null, null, 2, setOf(UserRole.SCHOOL_ADMIN))
        createMenuItem(
            "menu_list_classes",
            "list",
            "/admin/classes",
        ...
        val supervisorStudentManagement =
            createMenuItem("menu_student_management", "graduation-cap", null, null, 3, setOf(UserRole.SCHOOL_ADMIN))
        createMenuItem(
            "menu_list_students",
            "list",
            "/admin/students",
        ...
        val supervisorParentManagement =
            createMenuItem("menu_parent_management", "user", null, null, 4, setOf(UserRole.SCHOOL_ADMIN))
        createMenuItem(
            "menu_list_parents",
            "list",
            "/admin/parents",
        ...
        val supervisorFinance =
            createMenuItem("menu_finance", "dollar-sign", null, null, 5, setOf(UserRole.SCHOOL_ADMIN))
        createMenuItem(
            "menu_finance_tuition",
            "credit-card",
            "/admin/finance/tuition",
            "/admin/finance/tuition",
            0,
            setOf(UserRole.SCHOOL_ADMIN),
            supervisorFinance,
        ...
        // ==================== TEACHER MENU ====================
        createMenuItem(
            "menu_dashboard", "layout-dashboard", "/teacher/dashboard", "/teacher/dashboard", 0, setOf(UserRole.TEACHER)
        )
        createMenuItem(
            "menu_my_classes",
            "book-open",
        ...
        createMenuItem(
            ...
            5,
            setOf(UserRole.TEACHER),
            requiredPermission = "grades:manage"
        )
        createMenuItem(
            "menu_lesson_plans",
            "book",
            ...
            6,
            setOf(UserRole.TEACHER),
            requiredPermission = "lesson_plans:manage"
        )

        // ==================== STUDENT MENU ====================
        createMenuItem(
            "menu_dashboard", "layout-dashboard", "/student/dashboard", "/student/dashboard", 0, setOf(UserRole.STUDENT)
        )
        createMenuItem(
            "menu_my_profile",
            "user",
        ...
        // ==================== PARENT MENU ====================
        createMenuItem(
            "menu_dashboard", "layout-dashboard", "/parent/dashboard", "/parent/dashboard", 0, setOf(UserRole.PARENT)
        )
        createMenuItem(
            "menu_my_children",
            "users",
        ...
        createMenuItem(
            ...
            5,
            setOf(UserRole.PARENT),
            requiredPermission = "notifications:receive"
        )
        ...
        createMenuItem(
            "menu_expense_management",
            "trending-down",
            "/finance/expenses",
            "/finance/expenses",
            5,
            setOf(UserRole.FINANCE_TEAM),
            requiredPermission = "expenses:manage"
        )
