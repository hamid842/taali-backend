    ...
    fun translateText(key: String, locale: String = Locale.getDefault().language, vararg args: Any): String {
        ...
        return try {
            ...
            when (key) {
                ...
                "menu_schoolManagement" -> localizedMessages.menu_school_management()
                "menu_createSchool" -> localizedMessages.menu_create_school()
                "menu_listSchools" -> localizedMessages.menu_list_schools()
                "menu_userManagement" -> localizedMessages.menu_user_management()
                "menu_createUser" -> localizedMessages.menu_create_user()
                "menu_listUsers" -> localizedMessages.menu_list_users()
                "menu_finance" -> localizedMessages.menu_finance()
                "menu_teacherManagement" -> localizedMessages.menu_teacher_management()
                "menu_classManagement" -> localizedMessages.menu_class_management()
                "menu_studentManagement" -> localizedMessages.menu_student_management()
                "menu_parentManagement" -> localizedMessages.menu_parent_management()
                "menu_myClasses" -> localizedMessages.menu_my_classes()
                "menu_myStudents" -> localizedMessages.menu_my_students()
                "menu_attendance" -> localizedMessages.menu_attendance()
                "menu_assignments" -> localizedMessages.menu_assignments()
                "menu_myProfile" -> localizedMessages.menu_my_profile()
                "menu_myGrades" -> localizedMessages.menu_my_grades()
                "menu_myChildren" -> localizedMessages.menu_my_children()
                "menu_childrenGrades" -> localizedMessages.menu_children_grades()
                "menu_childrenAttendance" -> localizedMessages.menu_children_attendance()
                "menu_payments" -> localizedMessages.menu_payments()
                "menu_foodMenu" -> localizedMessages.menu_food_menu()
                "menu_orders" -> localizedMessages.menu_orders()
                "menu_inventory" -> localizedMessages.menu_inventory()
                "menu_financialReports" -> localizedMessages.menu_financial_reports()
                "menu_paymentManagement" -> localizedMessages.menu_payment_management()
                "menu_invoices" -> localizedMessages.menu_invoices()

                // Validation keys - updated to snake_case
                "validation_firstName_required" -> localizedMessages.validation_first_name_required()
                "validation_firstName_size" -> localizedMessages.validation_first_name_size()
                "validation_firstName_pattern.en" -> localizedMessages.validation_first_name_pattern_en()
                "validation_firstName_pattern.fa" -> localizedMessages.validation_first_name_pattern_fa()
                "validation_lastName_required" -> localizedMessages.validation_last_name_required()
                "validation_lastName_size" -> localizedMessages.validation_last_name_size()
                "validation_lastName_pattern.en" -> localizedMessages.validation_last_name_pattern_en()
                "validation_lastName_pattern.fa" -> localizedMessages.validation_last_name_pattern_fa()
                ...
                "toast_otpVerified" -> localizedMessages.toast_otp_verified()
                "toast_otpInvalid" -> localizedMessages.toast_otp_invalid()
                "toast_otpExpired" -> localizedMessages.toast_otp_expired()
                "toast_profileUpdated" -> localizedMessages.toast_profile_updated()
                "toast_passwordChanged" -> localizedMessages.toast_password_changed()
                "toast_otpSent" -> localizedMessages.toast_otp_sent()
                "toast_registerSuccess" -> localizedMessages.toast_register_success()
                "toast_registerFailed" -> localizedMessages.toast_register_failed()
                "toast_loginSuccess" -> localizedMessages.toast_login_success()
                "toast_loginFailed" -> localizedMessages.toast_login_failed()
                "toast_redirectingDashboard" -> localizedMessages.toast_redirecting_dashboard()
